...
from metric_bgsub.Background_sub.bsb import BSUB


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Depth Anything V2')
    
    parser.add_argument('--video-path', type=str, default='assets/examples_video/basketball.mp4')
    ...
    depth_anything = BSUB(**model_configs[args.encoder])
